...
//   const applyFilter=()=>{
//     if(speciality){
//       // setFilterDoc(doctors.filter(doc.speciality===speciality))
...
//           <p onClick={()=>speciality==='Pediatricians' ? navigate('/doctors') : navigate('/doctors/')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer`}>Pediatricians</p>
